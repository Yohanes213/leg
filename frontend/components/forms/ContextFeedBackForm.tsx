  ...
  //   const getLawTitle = (metadata: string | null | undefined, articleName: string | undefined): string => {
  //     try {
  //         if (!metadata) {
  //             return law_title || "No Title Found";
  //         }
  //         const parsedMetadata = JSON.parse(metadata || "{}");
  //         if (parsedMetadata && typeof parsedMetadata === 'object') {
  //             if (parsedMetadata.law_title) {
  //                 return `${parsedMetadata.law_title}`;
  //             }
  //            return articleName || "No Title Found";
  //         }
  //         return articleName || "No Title Found";
  ...
  const getLawTitle = (
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        const response = await fetch("http://74.241.130.204:1111/data_quality/submit-feedback", {
          method: "POST",
          headers: {
